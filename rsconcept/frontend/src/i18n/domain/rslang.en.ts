export const txRslangEn: Record<string, string> = {
  ...
  'tx.rsexpression.logic.hint': 'Expressions using logical connectives and quantifiers, whose values are TRUE or FALSE',
  'tx.rsexpression.set': 'Set operations',
  ...
  'tx.rsexpression.arithmetic': 'Arithmetic',
  ...
  'tx.rsexpression.recursive': 'Recursive expressions',
