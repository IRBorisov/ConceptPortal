export const txRslangRu: Record<string, string> = {
  ...
  'tx.rslang.error.invalidElementPredicate': 'Тип {a} не совместим с множеством {c} для оператора "{b}"',
  ...
  'tx.rslang.error.invalidQuantifierDomain':
    'В кванторной декларации "{operator}" ожидается множество, получен тип {type}',
  ...
  'tx.rslang.error.calcInvalidData': 'Значения {a} и {b} несовместимы для оператора "{operator}"',
