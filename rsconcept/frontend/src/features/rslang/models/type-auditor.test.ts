...
const errorData = [
  ...
  ['∀(a,b)∈X1 a=b', { code: RSErrorCode.invalidCortegeDeclare, position: 2, params: [] }],
  ...
  // Set operations
  ['X1 ∪ ∅', { code: RSErrorCode.invalidEmptySetUsage, position: 5, params: [] }],
  ...
  ['Fi1[X1,X1](S1)', { code: RSErrorCode.invalidFilterArity, position: 0, params: [] }],
...
describe('TypeAuditor', () => {
  ...
  // .filter(([input]) => input === 'D{t ∈ X1 | t=t} ∪ D{t∈ℬ(X1) | t⊄t}')
