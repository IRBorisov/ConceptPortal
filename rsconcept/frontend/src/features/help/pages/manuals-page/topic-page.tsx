...
import { HelpSchemaMenu } from '../../items/ui/help-rsmenu';
...
export function TopicPage({ topic }: TopicPageProps) {
  ...
  if (topic === HelpTopic.UI_SCHEMA_CARD) return <HelpRSCard />;
  if (topic === HelpTopic.UI_SCHEMA_LIST) return <HelpRSList />;
  if (topic === HelpTopic.UI_SCHEMA_EDITOR) return <HelpRSEditor />;
