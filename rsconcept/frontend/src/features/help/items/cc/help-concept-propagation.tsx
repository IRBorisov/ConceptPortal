  ...
  return (
    <div className='text-justify'>
      ...
      <p>
        ...
        автоматическому созданию, удалению или обновлению наследованных конституент. Если удаляемые конституенты находятся в
        таблице отождествлений одной из операций, то такие отождествления <u>будут автоматически отменены</u>.
      </p>
      <p>
