...
export function HelpCstAttributesRu() {
  const tx = useTx();
  return (
    <>
      ...
      <p>
        ...
        множества, задаваемого этим определением. Также может быть введена вручную для конституент, чьи определения еще
        не введены.
      </p>
      <p>
      ...
      <p>
        <code>T1 :== Pr1(S1)=Pr2(S1)</code> – Высказывания определяются логическим Формальным определением
      </p>
      <p>
