...
export function HelpRSLangExpressionParameterFr() {
  ...
  return (
    <>
      ...
      <p>
        Les expressions paramétrées du langage des genres de structures forment une classe indépendante de constructions.
        Elles sont utilisées pour déclarer des fonctions-terme et des fonctions-prédicat. L'appel de telles fonctions
        produit respectivement une expression ensembliste (EE) ou une expression logique (EL).
      </p>
      ...
      <ul>
        <li>
          Entre crochets, une liste ordonnée de déclarations de paramètres est fournie, séparée par des virgules.
        </li>
        <li>
          Un paramètre est déclaré à l'aide du prédicat d'appartenance <code>∈</code>. À gauche se trouve
          l'identifiant de la variable locale ; à droite, le domaine du paramètre.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Les typifications des arguments sont vérifiées par rapport aux typifications des paramètres déclarés.
        </li>
        <li>
