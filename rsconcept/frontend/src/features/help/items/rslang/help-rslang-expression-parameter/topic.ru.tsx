  ...
  return (
    <>
      ...
      <p>
        ...
        «ожидалось ζ∈ℬℬ(X1), получено Z». Для аргументов после первого в ожидаемой типизации подставляются уже
        выведенные по предыдущим аргументам значения радикалов — вместо <code>R1</code> будет показана конкретная
        ступень, как в примере выше.
      </p>
      <p>
        Если ошибка относится к первому аргументу и радикал ещё не выведен, в диагностике радикал может отображаться с
        именем функции, например <code>{'R1<P2>'}</code>.
      </p>
    </>
  );
}
