...
export function HelpThesaurusRu() {
  const tx = useTx();
  return (
    <>
      ...
      <p>
        Ядро КС – неопределяемые понятия, аксиомы и производные понятия, необходимые для формулировки аксиом. Остальные
      ...
      <ul>
        ...
        <li>Неопределяемое понятие не имеет определения и задано конвенцией и аксиомами.</li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          всех аксиом должна быть истинна, чтобы схема была теорией данной предметной области.
        </li>
        <li>
      ...
      <p>
        ...
        родовых структур интерпретация задаётся непосредственно пользователем; для аксиом, терминов и высказываний она
        может вычисляться по формальному определению на основе уже заданных значений.
      </p>
      <p>
