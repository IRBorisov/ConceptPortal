...
export function HelpInterfaceRu() {
  ...
  return (
    <>
      ...
      <p>
        Значок <IconTour className='inline-icon' /> означает, что для этой области доступен интерактивный тур: по
        нажатию открывается меню быстрого гида и перехода к руководству. Такая иконка остаётся видимой, даже если
        контекстная справка отключена.
      </p>
      <p>
