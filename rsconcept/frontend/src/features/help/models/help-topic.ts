...
export const HelpTopic = {
  ...
  UI_STRUCTURE_PLANNER: 'ui-structure-planner',
  UI_RSMODEL_CARD: 'ui-rsmodel-card',
  UI_RSMODEL_LIST: 'ui-rsmodel-list',
  UI_RSMODEL_VALUE: 'ui-rsmodel-value',
  UI_RSMODEL_VALUE_DIALOG: 'ui-rsmodel-value-dialog',
  UI_RSMODEL_EVALUATOR: 'ui-rsmodel-evaluator',
  UI_RSMODEL_STATUS: 'ui-rsmodel-status',
  UI_RSMODEL_BINDING: 'ui-rsmodel-binding',
...
export const topicParent = new Map<HelpTopic, HelpTopic>([
  ...
  [HelpTopic.UI_STRUCTURE_PLANNER, HelpTopic.INTERFACE],
  [HelpTopic.UI_RSMODEL_CARD, HelpTopic.INTERFACE],
  [HelpTopic.UI_RSMODEL_LIST, HelpTopic.INTERFACE],
  [HelpTopic.UI_RSMODEL_VALUE, HelpTopic.INTERFACE],
  [HelpTopic.UI_RSMODEL_VALUE_DIALOG, HelpTopic.INTERFACE],
  [HelpTopic.UI_RSMODEL_EVALUATOR, HelpTopic.INTERFACE],
  [HelpTopic.UI_RSMODEL_STATUS, HelpTopic.INTERFACE],
  [HelpTopic.UI_RSMODEL_BINDING, HelpTopic.INTERFACE],
  ...
  [HelpTopic.UI_OSS_CARD, HelpTopic.INTERFACE],
  ...
  [HelpTopic.CC_RSMODEL, HelpTopic.CONCEPTUAL],
