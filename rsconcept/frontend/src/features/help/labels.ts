...
const labelHelpTopicRecord: Record<HelpTopic, string> = {
  ...
  [HelpTopic.UI_RS_LIST]: 'Список схемы',
  [HelpTopic.UI_RS_EDITOR]: 'Редактор конституенты',
  [HelpTopic.UI_STRUCTURE_PLANNER]: 'Порождение структуры',
  [HelpTopic.UI_RSMODEL_CARD]: 'Паспорт модели',
  [HelpTopic.UI_RSMODEL_LIST]: 'Список модели',
  [HelpTopic.UI_RSMODEL_VALUE]: 'Данные модели',
  [HelpTopic.UI_RSMODEL_VALUE_DIALOG]: 'Диалог значения',
  [HelpTopic.UI_RSMODEL_EVALUATOR]: 'Расчет выражения',
  [HelpTopic.UI_RSMODEL_STATUS]: 'Статусы вычисления',
  [HelpTopic.UI_RSMODEL_BINDING]: 'Базовый источник',
...
const describeHelpTopicRecord: Record<HelpTopic, string> = {
  ...
  [HelpTopic.UI_RSMODEL_CARD]: 'атрибуты модели и связь со схемой',
  [HelpTopic.UI_RSMODEL_LIST]: 'табличная работа с составом модели',
  [HelpTopic.UI_RSMODEL_VALUE]: 'ввод, просмотр и редактирование значений модели',
  [HelpTopic.UI_RSMODEL_VALUE_DIALOG]: 'структурный просмотр и редактирование отдельного значения',
  [HelpTopic.UI_RSMODEL_EVALUATOR]: 'проверка и вычисление произвольных выражений',
  [HelpTopic.UI_RSMODEL_STATUS]: 'обозначения состояний вычисления',
  [HelpTopic.UI_RSMODEL_BINDING]: 'редактирование значений базисного множества',
