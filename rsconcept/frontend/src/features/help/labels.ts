...
const helpTopicLabelId: Record<HelpTopic, string> = {
  ...
  [HelpTopic.INTERFACE]: 'tx.general.ui.short',
  [HelpTopic.UI_LIBRARY]: 'tx.lib.library',
  [HelpTopic.UI_SCHEMA_MENU]: 'tx.schema.menu',
  [HelpTopic.UI_SCHEMA_CARD]: 'tx.schema.passport.short',
  [HelpTopic.UI_SCHEMA_LIST]: 'tx.schema.list.short',
  ...
  [HelpTopic.UI_MODEL_LIST]: 'tx.model.list.short',
  ...
  [HelpTopic.UI_OSS_GRAPH]: 'tx.oss.short',
  ...
  [HelpTopic.CC_SYNTHESIS]: 'tx.synthesis.short',
  [HelpTopic.CC_STRUCTURING]: 'tx.oss.structuring',
  [HelpTopic.CC_OSS]: 'tx.oss.short',
  ...
  [HelpTopic.RSL_EXPRESSION_SET]: 'tx.rsexpression.set.short',
  [HelpTopic.RSL_EXPRESSION_STRUCTURE]: 'tx.rsexpression.structure',
  [HelpTopic.RSL_EXPRESSION_ARITHMETIC]: 'tx.rsexpression.arithmetic.short',
  [HelpTopic.RSL_EXPRESSION_QUANTOR]: 'tx.rsexpression.quantifier',
  [HelpTopic.RSL_EXPRESSION_DECLARATIVE]: 'tx.rsexpression.declarative.short',
  [HelpTopic.RSL_EXPRESSION_IMPERATIVE]: 'tx.rsexpression.imperative.short',
  [HelpTopic.RSL_EXPRESSION_RECURSIVE]: 'tx.rsexpression.recursive.short',
  [HelpTopic.RSL_EXPRESSION_PARAMETER]: 'tx.rsexpression.parameter.short',
