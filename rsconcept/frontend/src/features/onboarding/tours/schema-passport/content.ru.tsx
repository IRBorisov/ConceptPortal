...
export const schemaPassportContentRu: Record<string, TourStepContent> = {
  ...
  form: {
    ...
    body: (
      <p>
        Заголовок — человекочитаемое название, имя — короткий идентификатор в библиотеке, описание фиксирует предметную
  ...
  stats: {
    ...
    body: (
      <div className='flex flex-col gap-2'>
        <p>
          Боковая панель суммирует схему: число конституент, ядро и производную часть, а также показатели корректности
          (ошибки и невычислимые определения).
        </p>
        <p>
          Раскройте категорию, чтобы увидеть разбивку — например базисные множества, аксиомы, термины и текстовые
          определения.
        </p>
      </div>
    )
