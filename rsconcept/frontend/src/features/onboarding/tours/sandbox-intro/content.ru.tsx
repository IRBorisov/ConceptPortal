  ...
  data: {
    ...
    body: (
      <p>
        ...
        предметной области. Нажмите «Подробнее» для вычисления, сохранения и привязки.
      </p>
    )
  },
  evaluation: {
    ...
    body: (
      <p>
        ...
        вычислить при текущих данных. Нажмите «Подробнее» для произвольных выражений и просмотра результата.
      </p>
    )
  },
  finish: {
