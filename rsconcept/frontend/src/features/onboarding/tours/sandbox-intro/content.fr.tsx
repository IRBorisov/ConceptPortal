  ...
  welcome: {
    ...
    body: (
      <div className='flex flex-col gap-2'>
        ...
        <p>
          Ce court tour présente les onglets de l&apos;éditeur. Sur certaines étapes, vous pouvez ouvrir un parcours
          détaillé de l&apos;onglet, ou le lancer plus tard depuis le menu lorsque vous êtes sur cet onglet.
        </p>
      </div>
    )
  },
  passport: {
    ...
    body: (
      <p>
        ...
        titre, alias et description. Utilisez Détails pour le formulaire et le panneau de statistiques.
      </p>
    )
  },
  list: {
    ...
    body: (
      <p>
        ...
        tableau — avec le statut d&apos;évaluation lorsqu&apos;un modèle est attaché. Utilisez Détails pour la
        recherche, la sélection et le réordonnancement.
      </p>
    )
  },
  concept: {
    ...
    body: (
      <p>
        ...
        textuelle et sa définition formelle. Utilisez Détails pour la vérification, les outils de syntaxe et le
        planificateur de structure.
      </p>
    )
  },
  graph: {
    ...
    body: (
      <p>
        ...
        concepts : quelles définitions dépendent de quelles autres. Utilisez Détails pour les options d&apos;affichage,
        les modes et la navigation sur le canevas.
      </p>
    )
  },
  data: {
  ...
  finish: {
    ...
    body: (
      <div className='flex flex-col gap-2'>
        ...
        <p>
          Explorez librement le bac à sable — vous pouvez toujours restaurer les données initiales depuis le menu,
          rouvrir cette vue d&apos;ensemble, ou lancer le tutoriel d&apos;un onglet depuis le menu lorsque vous y êtes.
          Consultez aussi les <TourHelpLink text='manuels' topic={HelpTopic.INTERFACE} />.
        </p>
      </div>
    )
  }
