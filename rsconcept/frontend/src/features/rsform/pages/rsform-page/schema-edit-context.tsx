...
export const SchemaEditContext = createContext<ISchemaEditContext | null>(null);
export const useSchemaEdit = () => {
  const context = use(SchemaEditContext);
  if (context === null) {
    throw new Error('useSchemaEdit has to be used within <SchemaEditState>');
  }
  return context;
};
