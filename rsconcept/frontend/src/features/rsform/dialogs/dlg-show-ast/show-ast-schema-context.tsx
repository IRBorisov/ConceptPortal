...
export function ShowAstSchemaProvider({ schema, children }: { schema: RSForm; children: ReactNode }) {
  return <ShowAstSchemaContext.Provider value={schema}>{children}</ShowAstSchemaContext.Provider>;
}
