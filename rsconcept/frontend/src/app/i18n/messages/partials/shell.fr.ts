...
export const shellFr: Record<string, string> = {
  ...
  'error.mutation.close': 'Fermer',
  'modal.closeDialogTooltip': 'Fermer la boîte de dialogue',
  'modal.close': 'Fermer',
  'modal.cancel': 'Annuler',
  'modal.submitContinue': 'Continuer',
  ...
  'auth.anonymous.create': 'Créer',
  'auth.anonymous.manuals': 'Aide',
  'auth.anonymous.logout': 'Se déconnecter',
  'auth.anonymous.logoutAria': 'Se déconnecter',
