export const libraryRu: Record<string, string> = {
  ...
  'lib.filter.placeholder': 'Фильтр',
  'lib.filter.label': 'Фильтр',
  'lib.filter.owner': 'Я владелец',
  'lib.filter.editor': 'Я редактор',
  'lib.filter.hidden': 'Скрытые',
  'lib.filter.rsforms': 'Схемы',
  'lib.filter.oss': 'ОСС',
  'lib.filter.rsmodels': 'Модели',
  'lib.col.alias': 'Сокращение',
  'lib.col.title': 'Название',
  'lib.col.owner': 'Владелец',
  'lib.col.dateShort': 'Дата',
  ...
  'lib.create.titlePlaceholder': 'Название',
  'lib.create.alias': 'Сокращение',
  'lib.create.access': 'Доступ',
