import {
  ...
  DiagnosticKind,
  getDiagnosticSeverity as getDomainDiagnosticSeverity,
  modelStatusCstDiagnostic,
  RSDiagnosticCode
} from '@rsconcept/domain/library';
import { EvalStatus } from '@rsconcept/domain/library/rsmodel';
import { RSErrorCode, type RSErrorDescription } from '@rsconcept/domain/rslang/error';
...
export function getDiagnosticSeverity(code: number): DiagnosticSeverity {
  return getDomainDiagnosticSeverity(code);
}
