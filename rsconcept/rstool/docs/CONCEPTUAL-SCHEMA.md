...
`X#`, `C#`, и `S#` — это **базовые понятия** (см. [DOMAIN.md](DOMAIN.md)); их нельзя строить одно из другого и включать друг в друга как элементы или подмножества.
...
При концептуализации вводи понятия по зависимостям: базовые (`X#`, `C#`, независимые `S#`), аксиомы `A#`, затем производные `D#` / `P#` / `A#`. Каждый шаг опирается только на уже введённые конституенты.
