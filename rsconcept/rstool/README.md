...
**Contract version:** `3.3.0` — see [skills/rstool-helper/REFERENCE.md](./skills/rstool-helper/REFERENCE.md) for the full v3 API.
...
Supported methods (contract `3.3.0`):
...
```json
{ "id": "1", "ok": true, "result": { "sessionId": "...", "contractVersion": "3.3.0" } }
```
...
```json
{
  ...
  "result": {
    "success": true,
    "session": { "sessionId": "...", "contractVersion": "3.3.0" },
    "summary": { "itemCount": 3 }
  }
}
```
